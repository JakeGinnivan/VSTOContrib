...
$interopAssembly = $project.Object.References | Where-Object { $_.Name.StartsWith('Microsoft.Office.Interop.Excel') }
...
{
    $toolsAssembly = $project.Object.References | Where-Object { $_.Name.StartsWith('Microsoft.Office.Tools.Excel') }
...
$vstoContribApplicationDll = Join-Path (Join-Path $toolsPath $netVersionFolder) "VSTOContrib.Excel.$officeVersion.dll"
